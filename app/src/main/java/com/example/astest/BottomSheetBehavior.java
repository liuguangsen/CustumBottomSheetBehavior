 ...
 *
 * 解决ViewPager只有第一个tab可以下拉滚动BottomSheet, 切换tab无法滚动
 */
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     * 参考
     */
    public static final int STATE_DRAGGING_OTHER_VIEW_OFFSET = 7;
    ...
    @IntDef({
            ...
            STATE_HIDDEN,
            STATE_HALF_EXPANDED,
            STATE_DRAGGING_OTHER_VIEW_OFFSET
    })
    ...
    @State public int state = STATE_COLLAPSED;
    ...
    /**
     * liugs 记录 外部view 拖动的top值
     */
    int otherViewDragHeight;
    ...
    public void onRestoreInstanceState(
        ...
        if (ss.state == STATE_DRAGGING || ss.state == STATE_SETTLING) {
            ...
            this.lastStableState = this.state;
            // liugs 恢复外部状态的高度值
            if (this.state == STATE_DRAGGING_OTHER_VIEW_OFFSET) {
                this.otherViewDragHeight = ss.otherViewDragHeight;
            }
        }
    }
    ...
    public boolean onLayoutChild(
        ...
        // liugs 外部view跟随拖动状态，根据otherViewDragHeight来重新计算
        if (state == STATE_DRAGGING_OTHER_VIEW_OFFSET) {
            savedTop = otherViewDragHeight;
        }
        ...
        } else if (state == STATE_DRAGGING || state == STATE_SETTLING || state == STATE_DRAGGING_OTHER_VIEW_OFFSET) {
    ...
    public void updateDrawableForTargetState(@State int state, boolean animate) {
        if (state == STATE_SETTLING || state == STATE_DRAGGING_OTHER_VIEW_OFFSET) {
    ...
    View findScrollingChild(View view) {
        ...
        /* liugs 修复ViewPager 只有第一个tab能滑动关闭BottomSheet*/
    ...
    /* 修复ViewPager 只有第一个tab能滑动关闭BottomSheet*/
    public static View getCurrentView(ViewPager viewPager) {
        final int currentItem = viewPager.getCurrentItem();
        for (int i = 0; i < viewPager.getChildCount(); i++) {
            View child = viewPager.getChildAt(i);
            Object instantiateItem = viewPager.getAdapter().instantiateItem(viewPager, viewPager.getCurrentItem());
            Object instantiateItemView = instantiateItem;
            if (instantiateItem instanceof Fragment) {
                instantiateItemView = ((Fragment) instantiateItem).getView();
            }
            if (instantiateItemView == child) {
                return child;
            }
        }
        return null;
    ...
    private void startSettling(View child, @StableState int state, boolean isReleasingView) {
        ...
        if (settling) {
            int settlingState = STATE_SETTLING;
            if(state == STATE_DRAGGING_OTHER_VIEW_OFFSET) settlingState = state;
            setStateInternal(settlingState);
    ...
    private int getTopOffsetForState(@StableState int state) {
        switch (state) {
            ...
            case STATE_HIDDEN:
                return parentHeight;
            case STATE_DRAGGING_OTHER_VIEW_OFFSET:
                return otherViewDragHeight;
            default:
                // Fall through
        }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(@NonNull Parcel source, ClassLoader loader) {
            ...
            otherViewDragHeight = source.readInt();
        }
        ...
        public SavedState(Parcelable superState, @NonNull BottomSheetBehavior<?> behavior) {
            ...
            this.otherViewDragHeight = behavior.otherViewDragHeight;
        }

        /**
         * This constructor does not respect flags: {@link com.google.android.material.bottomsheet.BottomSheetBehavior#SAVE_PEEK_HEIGHT}, {@link
         * com.google.android.material.bottomsheet.BottomSheetBehavior#SAVE_FIT_TO_CONTENTS}, {@link com.google.android.material.bottomsheet.BottomSheetBehavior#SAVE_HIDEABLE}, {@link
         * com.google.android.material.bottomsheet.BottomSheetBehavior#SAVE_SKIP_COLLAPSED}. It is as if {@link com.google.android.material.bottomsheet.BottomSheetBehavior#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link #(Parcelable, com.google.android.material.bottomsheet.BottomSheetBehavior)} instead.
         */
        @Deprecated
        ...
        public void writeToParcel(@NonNull Parcel out, int flags) {
            ...
            out.writeInt(otherViewDragHeight);
        }
    ...
    /**
     * A utility function to get the {@link com.google.android.material.bottomsheet.BottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link com.google.android.material.bottomsheet.BottomSheetBehavior}.
     * @return The {@link com.google.android.material.bottomsheet.BottomSheetBehavior} associated with the {@code view}.
     */
    @NonNull
